...
右上に「投稿」ボタンが配置されているのが分かると思います。個人的にはこの位置のボタンは指が届かないので若干使いづらいです。
...
それっぽいボタンが追加されました！右上のボタンではなく、このボタンを使用して投稿画面に移動できるようになりました。
...
また、Mastodon のサーバを立てていると、自分が改造した画面を使って投稿ができるだけでなく、人の投稿もそこに流れてくるのでちょっと不思議な感じがします。
